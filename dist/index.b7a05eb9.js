...
class DotManager {
    ...
    deleteDot(dot) {
        ...
        const newDot = new (0, _dots.Dot)(this);
        this.dots.add(newDot);
    }
    run() {
        for (const dot of this.dots)dot.run();
    }
}
...
var _main = require("./main");
class Dot {
    constructor(manager, x, y, radius, color){
        this.alpha = 0;
        this.fadeSpeed = (0, _helpers.random)((0, _settings.minFadeSpeed), (0, _settings.maxFadeSpeed));
        this.fadeDirection = 1;
        this.fading = true;
        this.manager = manager;
        this.x = x || (0, _helpers.random)(0, (0, _main.canvas).width);
        this.y = y || (0, _helpers.random)(0, (0, _main.canvas).height);
    ...
    generateGray(gray = (0, _helpers.random)((0, _settings.minGray), 255)) {
        return `rgb(${gray}, ${gray}, ${gray})`;
    }
    draw() {
        (0, _main.ctx).beginPath();
        (0, _main.ctx).arc(this.x, this.y, this.radius, 0, Math.PI * 2);
        (0, _main.ctx).closePath();
        (0, _main.ctx).fillStyle = this.color;
        (0, _main.ctx).globalAlpha = (0, _helpers.constrain)(this.alpha, 0, 1);
        (0, _main.ctx).fill();
    }
    delete() {
        this.fadeDirection = -1;
    ...
    run() {
        if (this.fading) {
            ...
            if (this.alpha <= -0.5 || this.alpha >= 1.5) this.fadeDirection *= -1;
        }
        if (this.x < 0 || this.y > (0, _main.canvas).height) this.delete();
        this.x -= this.speed;
        this.y += this.speed;
        this.draw();
    }
...
parcelHelpers.export(exports, "minSpeed", ()=>minSpeed);
parcelHelpers.export(exports, "maxSpeed", ()=>maxSpeed);
parcelHelpers.export(exports, "minFadeSpeed", ()=>minFadeSpeed);
parcelHelpers.export(exports, "maxFadeSpeed", ()=>maxFadeSpeed);
parcelHelpers.export(exports, "minRadius", ()=>minRadius);
parcelHelpers.export(exports, "maxRadius", ()=>maxRadius);
const minGray = 90;
const minSpeed = 0.1;
const maxSpeed = 2;
const minFadeSpeed = 10e-6;
const maxFadeSpeed = 10e-3;
const minRadius = 10;
const maxRadius = 500;
...
},{}],"25CX2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dZI1r","jeorp"], "jeorp", "parcelRequire10a8")
